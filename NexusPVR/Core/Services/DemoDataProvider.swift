...
struct DemoDataProvider {
    ...
    private static let programTemplates: [Int: [(String, String?, String, [String], Int)]] = [
        1001: [
            ...
            ("Fantasy Draft Live ᴺᵉʷ", nil, "Expert analysis for your fantasy league picks.", ["Sports"], 120),
        ...
        1006: [
            ...
            ("Ocean Mysteries ᴺᵉʷ", "The Deep", "Creatures of the abyss that defy imagination.", ["Documentary", "Nature"], 60),
        ...
        1009: [
            ...
            ("Robot Roommate ᴺᵉʷ", "S02E05 - The Dishwasher Dispute", "The AI refuses to load the dishwasher incorrectly and threatens to unionize.", ["Sci-Fi", "Comedy"], 30),
        ...
        1010: [
            ...
            ("Bake It Till You Make It ᴺᵉʷ", "Season 3", "Amateur bakers face impossible pastry challenges.", ["Food", "Competition"], 90),
        ...
        1014: [
            ...
            ("Cold Case Files ᴺᵉʷ", "S07E04 - The Lighthouse Keeper", "A journal found in a sealed lighthouse room reopens a coastal disappearance.", ["True Crime", "Documentary"], 60),
            ("Missing Persons Unit ᴺᵉʷ", "S02E15 - The Bus Stop", "Investigators race against time after a commuter vanishes from a busy transit hub.", ["True Crime", "Drama"], 60),
        ...
        1015: [
            ...
            ("Mountain Expedition: K2 ᴺᵉʷ", nil, "Following climbers on the world's most dangerous ascent.", ["Travel", "Adventure"], 90),
